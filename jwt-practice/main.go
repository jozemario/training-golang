...
func GetDatabase() *gorm.DB {
	databaseHost := goDotEnvVariable("DB_HOST")
	databasePort := goDotEnvVariable("DB_PORT")
	databaseName := goDotEnvVariable("DB_NAME")
	databaseUser := goDotEnvVariable("DB_USER")
	database := goDotEnvVariable("DB_TYPE")
	databasePassword := goDotEnvVariable("DB_PASS")
	databaseUrl := "postgres://" + databaseUser + ":" + databasePassword + "@" + databaseHost + ":" + databasePort + "/" + databaseName + "?sslmode=disable"
...
func IsAuthorized(handler http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Println("JWT TOKEN: " + strings.Split(r.Header["Authorization"][0], "Bearer ")[1])
